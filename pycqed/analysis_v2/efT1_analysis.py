...
class efT1_analysis(ba.BaseDataAnalysis):
    ...
    def run_fitting(self):
        ...
        doubledecay_mod.set_param_hint('tau2', value=tau2_best, min=0, vary=False)
        doubledecay_mod.set_param_hint('amplitude1', value=1.0, min=0, vary=True)
        ...
        doubledecay_mod = lmfit.Model(DoubleExpDecayFunclocal2, independent_vars='t')
        doubledecay_mod.set_param_hint('tau1', value=tau1_best, min=0, vary=False)
        doubledecay_mod.set_param_hint('tau2', value=tau2_best, min=0, vary=False)
        doubledecay_mod.set_param_hint('amplitude1', value=amplitude1_best, min=0, vary=False)
        doubledecay_mod.set_param_hint('amplitude2', value=amplitude2_best, min=0, vary=False)
        doubledecay_mod.set_param_hint('offset', value=.0, vary=True)
...
def DoubleExpDecayFunclocal2(t, tau1, tau2, amplitude1, amplitude2, offset):
    return amplitude1/tau1 * np.exp(-(t / tau1)) - amplitude2/tau2* np.exp(-(t / tau2)) + offset