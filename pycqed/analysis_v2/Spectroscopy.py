...
# Why is this class here when we have spectroscopy_analysis.py?

# """
raise NotImplementedError('Spectroscopy.py is outdated, use spectroscopy_analysis.py instead')\
# ## TODO: Delete this class by June 2019?
...
#         if self.do_fitting:
#             for fit_dict in self.fit_dicts.values():
