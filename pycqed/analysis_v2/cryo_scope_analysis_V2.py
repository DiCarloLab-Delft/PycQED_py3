...
class RamZFluxArc(ba.BaseDataAnalysis):
    ...
    def __init__(self, raw_data, t_start: str=None, t_stop: str=None, label='arc',
    ...
    def extract_data(self):
        ...
        for t in self.timestamps:
            ...
            data = self.raw_data[self.ch_idx_cos] + 1j * \
                self.raw_data[self.ch_idx_sin]
        ...
        self.raw_data_dict['data'] = self.raw_data
...
class Cryoscope_Analysis(ba.BaseDataAnalysis):
    ...
    def __init__(
            self, raw_data, t_start: str=None,
            t_stop: str =None,
            label='',
            qubit_label='',
    ...
    def extract_data(self):
        ...
        for i, timestamp in enumerate(self.timestamps):
            ...
            if i == 0:
                ...
                self.raw_data_dict['data'] =\
                    self.raw_data[self.ch_idx_cos] + \
                    1j * self.raw_data[self.ch_idx_sin]
