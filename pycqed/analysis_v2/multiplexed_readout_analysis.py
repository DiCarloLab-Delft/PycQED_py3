...
from pycqed.analysis.tools.plotting import set_xlabel, set_ylabel, \
    set_cbarlabel, flex_colormesh_plot_vs_xy, cmap_to_alpha, cmap_first_to_alpha
...
class Multiplexed_Readout_Analysis(ba.BaseDataAnalysis):
    ...
    def process_data(self): 
        ...
        for i, ch_name in enumerate(value_names):
            ...
            for j, comb in enumerate(combinations):
                cnts, bin_edges = np.histogram(ch_data[j::len(combinations)], 
        ...
        for i, ch_name in enumerate(value_names):
            ...
            mn_voltages[ch_name]['threshold']=np.mean([mn_voltages[ch_name]['0'],    
        ...
        for i, vn in enumerate(value_names):
            digitized_data[:,i] = np.array(raw_shots[:, i] > 
                mn_voltages[vn]['threshold'], dtype=int)
    ...
    def prepare_plots(self):
        self.plot_dicts['assignment_probability_matrix'] = {
                ...
                'assignment_prob_matrix': self.proc_data_dict['assignment_prob_matrix'],
...
def plot_mux_ssro_histograms(
        ...
        for i, (key, (cnts, bin_centers)) in enumerate(hist_data.items()):
            if key[qubit_idx] == '0': 
                ...
                raise ValueError('{}  {}'.format(combinations, combinations[qubit_idx]))
