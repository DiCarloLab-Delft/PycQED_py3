...
class Test_ZI_HDAWG8(unittest.TestCase):
  ...
  def setup_class(cls):
    print('Connecting...')
    cls.hd = HDAWG.ZI_HDAWG8(name='MOCK_HD', server='emulator', num_codewords=32, device='dev8026', interface='1GbE')
  ...
  def test_dynamic_waveform_upload(self):
      ...
      self.assertEqual(Test_ZI_HDAWG8.hd._awgModule.get_compilation_count(0), 1)
  
      # Modify a waveform
      Test_ZI_HDAWG8.hd.wave_ch1_cw000(0.5*Test_ZI_HDAWG8.hd.wave_ch1_cw000())
      ...
      w0 = numpy.concatenate((Test_ZI_HDAWG8.hd.wave_ch1_cw000(), Test_ZI_HDAWG8.hd.wave_ch1_cw000()))
      ...
      self.assertEqual(Test_ZI_HDAWG8.hd._awgModule.get_compilation_count(0), 2)