...
# choose (e.g. use VISA for IEE488 bus units, and IpInstrument for networked units). This would also make the inits cleaner
...
#		self.write(binMsg.decode())		# FIXME: Instrument does not have writeBinary, see whether this works
	...
	def getByteCntFromHeader(headerStr):
		...
		#byteCnt = sscanf(headerStr(3:end), formatString)	# NB: skip first '#N'
		return byteCnt
