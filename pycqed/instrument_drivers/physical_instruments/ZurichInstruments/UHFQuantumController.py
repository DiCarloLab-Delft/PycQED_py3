...
class UHFQC(zibase.ZI_base_instrument, DIO.CalInterface):
    ...
    DIOS_0_EXTCLK_50MHZ = 2  # FIXME: not in "node_doc_UHFQA.json" generated by fpga_revision=64387, 65825 (release 20.01)
    ...
    QAS_0_RESULT_SOURCE_RSLT_AFTER_CROSSTALK = 0 # "0": "Result after crosstalk unit."
    QAS_0_RESULT_SOURCE_RSLT_AFTER_THRESHOLD = 1 # "1": "Result after Threshold unit."
    QAS_0_RESULT_SOURCE_RSLT_AFTER_ROTATION = 2 # "2": "Result after Rotation unit."
    # NB: value 3 is not defined
    QAS_0_RESULT_SOURCE_CORR_AFTER_CROSSTALK = 4 # "4": "Correlation unit after the Crosstalk unit."
    QAS_0_RESULT_SOURCE_CORR_AFTER_THRESHOLD = 5 # "5": "Correlation unit after the Threshold unit."
    ...
    def assure_ext_clock(self) -> None:
        ...
        log.info('Switching to external clock. This could take a while!')
        while True:
            ...
            if self.system_extclk() != 1:
                log.warning('Switching to external clock failed. Trying again.')
            else:
                break
        log.info('Switched to external clock')
    ...
    def load_default_settings(self, upload_sequence=True) -> None:
        ...
        if self._use_dio:
            ...
            self.dios_0_extclk(self.DIOS_0_EXTCLK_50MHZ)  # 50 MHz clocking of the DIO. NB: feature introduced in 2019, FW version TBD
        ...
        self.qas_0_result_source(self.QAS_0_RESULT_SOURCE_RSLT_AFTER_ROTATION)
...
setUserReg(4, err_cnt);"""
    ...
    def awg_sequence_acquisition_and_DIO_RED_test(
        ...
        # setting the acquisition delay samples
        delay_samples = int(acquisition_delay*1.8e9/8)
        self.set(f"awgs_0_userregs_{self.USER_REG_WAIT_DLY}", delay_samples)
        sequence = f"""
            // program: awg_sequence_acquisition_and_DIO_RED_test
...
"""
        ...
        # FIXME: comment does not match info from node_doc: QuExpress thresholds on DIO (mode == 2), AWG control of DIO (mode == 1)
        self.dios_0_mode(self.DIOS_0_MODE_AWG_WAV)
        ...
        self.qas_0_result_source(self.QAS_0_RESULT_SOURCE_RSLT_AFTER_CROSSTALK)
        self.qas_0_result_enable(1)
    ...
    def calibrate_dio_protocol(self, dio_mask: int, expected_sequence: List, port: int=0):
        ...
        # And configure the delays
        self._set_dio_calibration_delay(min_valid_delay)  # FIXME: see HDAWG
