<<<<<<< HEAD
"""
This file provides compatibility for existing code. The functionality of this file had been moved to HAL_Transmon.py
"""

# these imports just rename the new names to the legacy names
from .HAL_Transmon import HAL_Transmon as CCLight_Transmon
=======
...
class CCLight_Transmon(Qubit):
    ...
    def add_spec_parameters(self):
        ...
        self.add_parameter('spec_pulse_length',
                           ...
                           unit='s', vals=vals.Numbers(0e-9, 50e-6),
    ...
    def measure_RO_QND(
        ...
        # ensure readout settings are restored
    ...
    def measure_spin_locking_simple(self, times=None, MC=None,
                     analyze=True, close_fig=True, update=True,
                     label: str = '', prepare_for_timedomain=True,
                     tomo=False, mw_gate_duration: float = 40e-9):
        # docstring from parent class
        # N.B. this is a good example for a generic timedomain experiment using
        # the CCL transmon.
        if MC is None:
    ...
    def measure_rabi_frequency(self, times=None, MC=None,
        ...
        p = sqo.rabi_frequency(times, qubit_idx=self.cfg_qubit_nr(),
                     platf_cfg=self.cfg_openql_platform_fn(),
                     mw_gate_duration=mw_gate_duration, tomo=tomo)
        s = swf.OpenQL_Sweep(openql_program=p,
                             CCL=self.instr_CC.get_instr(),
                             parameter_name="Time", unit="s")
        d = self.int_avg_det
